...
function Icons (id){
    const iconsForLearn = [
        ...
        {0: <BottleOn width={36} height={36} className="scroll"/>, 1:<BottleOff width={28} height={28} />, 2: <BottleOn />,  "text":"Пластик"},
        ...
        {0: <Icon28WheelOutline fill={colorOn} width={36} height={36} className="scroll"/>, 1: <Icon28WheelOutline fill={colorOff}/>,  2: <Icon28WheelOutline fill={colorOn}/>, "text":"Шины"},
        ...
        {0: <Icon24DonateOutline fill={colorOn} width={36} height={36} className="scroll"/>, 1: <Icon24DonateOutline fill={colorOff}/>, 2: <Icon24DonateOutline fill={colorOn}/>,  "text":"Крышечки"},
        {0: <Icon28MotorcycleOutline fill={colorOn} width={36} height={36} className="scroll"/>, 1: <Icon28MotorcycleOutline fill={colorOff}/>, 2: <Icon28MotorcycleOutline fill={colorOn}/>,  "text":"Металл"},
